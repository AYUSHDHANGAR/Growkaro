...
export default function AdCreationPage() {
    ...
    const plan = useMemo(() => {
        ...
        const primaryText = cleanIndustry.includes("loan")
    ...
    return (<AppShell eyebrow="Creation and guidance" title="Ad creation guide" description="Pick a business category, promotion channel, and objective to generate a clean starting ad plan.">
      <AuthGate title="Login required for ad creation" description="Sign in before generating campaign copy, channel advice, or reusable ad plans.">
        ...
        <div className="grid gap-5">
          ...
          <section className="glass-panel rounded-lg p-5">
            ...
            <div className="mt-4 grid gap-3 md:grid-cols-2">
              {Object.entries(channelAdvice).map(([name, advice]) => (<div key={name} className="flex gap-3 rounded-lg border border-white/10 bg-white/[0.04] p-4">
