...
export function ServiceOperations() {
    return (<section className="mx-auto w-full max-w-7xl px-5 py-16">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        {modules.map((module) => (<article data-gsap="scale-in" key={module.title} className="glass-panel rounded-lg p-5">
