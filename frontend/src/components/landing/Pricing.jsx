...
export function Pricing() {
    return (<section id="pricing" className="mx-auto w-full max-w-7xl px-5 py-16">
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        {tiers.map((tier) => (<article key={tier.name} className={`glass-panel rounded-3xl p-7 ${tier.featured ? "border-cyanEdge/55 shadow-glow" : ""}`}>
            ...
            <div className="grid gap-3">
              {tier.features.map((feature) => (<div key={feature} className="flex items-center gap-3 text-sm font-semibold text-white/72">
