...
export function FeatureShowcase() {
    return (<section id="target-ads" className="mx-auto w-full max-w-7xl px-5 py-16">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        {features.map((feature, index) => (<motion.article key={feature.title} initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-80px" }} transition={{ delay: index * 0.05 }} className="glass-panel rounded-3xl p-6">
