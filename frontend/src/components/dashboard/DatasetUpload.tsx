...
export function DatasetUpload({ onStats }: DatasetUploadProps) {
  ...
  return (
    <section id="upload" className="glass-panel rounded-3xl p-6">
      <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 rounded-2xl bg-cyanEdge px-5 py-3 font-black text-midnight transition hover:bg-white"
        >
