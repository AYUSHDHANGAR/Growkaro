...
export function ModelComparison() {
    return (<section id="models" className="glass-panel rounded-3xl p-6">
      ...
      <div className="grid gap-5 lg:grid-cols-[1fr_360px]">
        ...
        <div className="grid gap-3">
          {comparisonMetrics.map((model) => (<div key={model.algorithm} className="rounded-2xl border border-white/10 bg-white/[0.04] p-4">
